 ...
 ***************************************************************************************************/
#define M_LcdDataBus LATC
#define M_LcdDataBusDirection TRISC
#define M_LcdDataBusInput LATC

#define M_LcdControlBus LATB
#define M_LcdControlBusDirection TRISB
...
#define LCD_RS  4
//#define LCD_RW  5  /* Comment this line if RW pin is not used(grounded) */
#define LCD_EN  6
/*************************************************************************************************/
