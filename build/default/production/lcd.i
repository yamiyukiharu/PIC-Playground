...
# 5 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.00\\pic\\include\\c99\\stdarg.h" 2 3
...
uint8_t VAR_LcdTrackLineNum_U8;
uint8_t VAR_LcdTrackCursorPos_U8;
LcdConfig_st STK_LCDConfig;
...
void LCD_Init(uint8_t var_lcdMode_u8, uint8_t var_lcdNoOfLines_u8, uint8_t var_MaxCharsPerLine_u8)
{
 ...
 TRISC = 0x00u;
 TRISB = 0x00u;
 STK_LCDConfig.mvar_LcdMode_U8 = var_lcdMode_u8;
 STK_LCDConfig.mvar_MaxSupportedChars_U8 = var_MaxCharsPerLine_u8;
 ...
 if(STK_LCDConfig.mvar_LcdMode_U8 == 8u)
 {
  LCD_CmdWrite(0x38u);
 }
 else if(STK_LCDConfig.mvar_LcdMode_U8 == 4u)
 {
  lcd_Reset();
  LCD_CmdWrite(0x28u);
 }
...
static void lcd_SendNibble(uint8_t var)
{
 (((((var)&((1<<(5))))!=0u))? ((LATC) |= (1<<(5))): ((LATC) &= ~(1<<(5))));
 (((((var)&((1<<(4))))!=0u))? ((LATC) |= (1<<(4))): ((LATC) &= ~(1<<(4))));
 (((((var)&((1<<(3))))!=0u))? ((LATC) |= (1<<(3))): ((LATC) &= ~(1<<(3))));
 (((((var)&((1<<(6))))!=0u))? ((LATC) |= (1<<(6))): ((LATC) &= ~(1<<(6))));
}
# 935 "lcd.c"
static void lcd_SendCmdSignals()
{
